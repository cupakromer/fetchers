  ...
  describe Etsy do
    describe "#fetch" do
      before(:each) do
        ...
        @url = "http://openapi.etsy.com/v2/listings/active?api_key=random_api_key&limit=5&sort_on=created&sort_order=down&keywords=harry,potter&fields=title,price,currency_code,url,ending_tsz"
